# Checkout Domain error codes

This catalogue of error codes are generated from the Checkout Domain which is comprised of the below components.

**Checkout API**: An API that leverages core domains to assist in building a price for a collection of items.
...
| E-CHK-0098                 | MarketplaceCurrencyNotMatchingCountry         | Marketplace order currency does not match expected basket currency.                                                                                                |
